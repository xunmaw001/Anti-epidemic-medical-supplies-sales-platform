		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`kangyiwupin`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.wupinmingcheng;
																														// 轮播图片
					vue.swiperList = vue.detail.wupintupian ? vue.detail.wupintupian.split(",") : [];
																																																																	var swiperItemHtml = '';
