...
<body>
  <div id="app">
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in kangyiwupinList" v-bind:key="index" @click="jump('../kangyiwupin/detail.jsp?id='+item.id)">
              <img :src="item.wupintupian?item.wupintupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.wupinmingcheng}}</h6>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in yiqingtieshiList" v-bind:key="index" @click="jump('../yiqingtieshi/detail.jsp?id='+item.id)">
              <img :src="item.peitu?item.peitu.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.biaoti}}</h6>
                <p v-if="item.price">{{item.price}} RMB</p>
              </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`kangyiwupin/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.kangyiwupinList = res.data.list;
      });
      http.request(`yiqingtieshi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.yiqingtieshiList = res.data.list;
      });
    });
  </script>
</body>
