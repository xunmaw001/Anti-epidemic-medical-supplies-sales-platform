...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yonghu')">用户<i id="yonghuIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yonghuCell  = document.createElement('td');

						 yonghuCell.innerHTML = item.yonghu;


			row.appendChild(yonghuCell);
