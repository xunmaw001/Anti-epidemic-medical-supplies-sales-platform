...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">疫情贴士管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>疫情贴士列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">疫情贴士列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var peituCell  = document.createElement('td');

				                var peituImg = document.createElement('img');
			peituImg.setAttribute('src',item.peitu);
			peituImg.setAttribute('height',100);
			peituImg.setAttribute('width',100);
			peituCell.appendChild(peituImg);


			row.appendChild(peituCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yiqingtieshi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yiqingtieshi");
